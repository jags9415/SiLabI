/**
 * @api {get} /v1/professors/:username/reservations Retrieve a list of reservations.
 * @apiVersion 1.0.0
 ...
 * 		GET /professors/gjackson/reservations?q=created_at+gt+2015-03-12T00:00:00 HTTP/1.1
 ...
 *      GET /professors/gjackson/reservations?fields=start_time,end_time HTTP/1.1
 *      Retrieves only the start_time and end_time.
 *
 * @apiParamExample Example sort:
 *      GET /professors/gjackson/reservations?sort=id HTTP/1.1
 *      Order the results by ascending id.
 *
 * @apiParamExample Full example:
 *      GET /professors/gjackson/reservations?q=created_at+gt+2015-03-12T00:00:00&fields=start_time,end_time&sort=id HTTP/1.1
 *
