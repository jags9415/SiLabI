/**
 * @api {get} /v1/appointments Retrieve a list of appointments.
 * @apiVersion 1.0.0
 ...
 * 		GET /appointments?q=created_at+gt+2015-03-12T00:00:00 HTTP/1.1
 ...
 *      GET /appointments?fields=date HTTP/1.1
 *      Retrieves only the date.
 *
 * @apiParamExample Example sort:
 *      GET /appointments?sort=id HTTP/1.1
 *      Order the results by ascending id.
 *
 * @apiParamExample Full example:
 *      GET /appointments?q=created_at+gt+2015-03-12T00:00:00&fields=date&sort=id HTTP/1.1
 *
 ...
 * @apiSuccess {String="Por iniciar, Cancelada, Finalizada,  Inactiva"}	results.state			  The appointment state.
