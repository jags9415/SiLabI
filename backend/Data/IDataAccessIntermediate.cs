...
namespace SiLabI.Data
{
    ...
    public interface IDataAccessIntermediate
    {
        ...
        DataTable GetAll(Dictionary<string, object> payload, int id, QueryString request);
        ...
        void Create(Dictionary<string, object> payload, int id, object obj);
        ...
        void Update(Dictionary<string, object> payload, int id, object obj);
        ...
        void Delete(Dictionary<string, object> payload, int id, object obj);
    }
}