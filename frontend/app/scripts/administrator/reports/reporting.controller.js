(function() {
  ...
  ReportCreateController.$inject = ['$scope', '$routeParams', 'ProfessorReservationService', 'MessageService',  'PeriodService', 'GroupService', 'DateService', 'StudentAppService', 'StudentService', 'ProfessorService', 'ReportingService', '$location', '$localStorage'];
