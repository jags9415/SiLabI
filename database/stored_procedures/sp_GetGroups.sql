IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetGroups]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetGroups]
GO
...
-- Description:	Get the list of group that match a query.
-- =============================================
