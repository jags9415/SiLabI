IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetAdministrators]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetAdministrators]
GO
...
-- Description:	Get the list of administrators that match a query.
-- =============================================
