IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetCourses]') AND type in (N'P', N'PC'))
...
-- Description:	Get the list of courses that match a query.
-- =============================================
