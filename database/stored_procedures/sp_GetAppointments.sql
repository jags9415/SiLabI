IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetAppointments]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetAppointments]
GO
...
-- Description:	Get the list of appointments that match a query.
-- =============================================
