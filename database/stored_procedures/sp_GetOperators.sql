IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetOperators]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetOperators]
GO
...
-- Description:	Get the list of operators that match a query.
-- =============================================
