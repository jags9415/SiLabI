IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetSoftwares]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetSoftwares]
GO
...
-- Description:	Get the list of software that match a query.
-- =============================================
