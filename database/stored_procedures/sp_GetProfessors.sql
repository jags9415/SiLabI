IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetProfessors]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_GetProfessors]
GO
...
-- Description:	Get the list of professors that match a query.
-- =============================================
