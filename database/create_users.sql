...
GRANT EXECUTE ON [dbo].[sp_GetSoftwareByCode] TO [public_data_reader]
...
GRANT INSERT, UPDATE ON [dbo].[StudentsByGroup] TO [public_data_writer]
GRANT INSERT, UPDATE ON [dbo].[SoftwareByLaboratory] TO [public_data_writer]
...
GRANT SELECT ON [dbo].[StudentsByGroup] TO [protected_data_reader]
...
GRANT EXECUTE ON [dbo].[sp_GetStudentsByGroup] TO [protected_data_reader]
GRANT EXECUTE ON [dbo].[sp_GetGroupsByStudent] TO [protected_data_reader]
